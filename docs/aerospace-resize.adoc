...
If the focused window is floating, its frame is resized directly: the top-left corner stays put,
and `smart`/`smart-opposite` change both dimensions. (This fork; upstream fails on floating
windows.)
